...
**Примечание по нагрузочному тестированию:** провести полноценное нагрузочное тестирование сейчас невозможно, так как нет возможности выполнять такие прогоны на ресурсах бизнеса.
